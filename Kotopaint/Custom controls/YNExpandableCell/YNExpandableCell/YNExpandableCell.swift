...
open class YNExpandableCell: UITableViewCell {
    ...
    open func initView() {
        ...
        self.normalCustomAccessoryType = UIImageView(frame: CGRect(x: width - 64, y: (height-26)/2, width: 26, height: 26))
        ...
        self.selectedCustomAccessoryType = UIImageView(frame: CGRect(x: width - 64, y: (height-26)/2, width: 26, height: 26))
